...
import com.dadadadev.prototype_me.board.ui.components.AddEntityToolbar
import com.dadadadev.prototype_me.board.ui.components.ConnectingHintBanner
import com.dadadadev.prototype_me.board.ui.components.EdgesLayer
import com.dadadadev.prototype_me.board.ui.components.EdgeSelectionToolbar
import com.dadadadev.prototype_me.board.ui.components.GridBackground
import com.dadadadev.prototype_me.board.ui.components.MultiSelectMenu
import com.dadadadev.prototype_me.board.ui.components.NodeActionMenu
import com.dadadadev.prototype_me.board.ui.components.NodesLayer
import com.dadadadev.prototype_me.board.ui.components.SelectionMarquee
import com.dadadadev.prototype_me.board.ui.dialogs.AddEntityDialog
import com.dadadadev.prototype_me.board.ui.dialogs.NodeDetailDialog
                        ...
                        while (true) {
                            ...
                            if (event.buttons.isSecondaryPressed) {
                                ...
                                if (pan.getDistance() > 0f) {
                                    if (!secondaryMoved) {
                                        val start = secondaryDownPos ?: change.position
                        ...
                        awaitPointerEventScope {
                            ...
                            while (true) {
                                ...
                                if (event.buttons.isPrimaryPressed && !event.buttons.isSecondaryPressed) {
                                    ...
                                    val start = primaryDownPos ?: change.position
...
private fun buildEdgeHitPolylines(
    edges: List<com.dadadadev.prototype_me.domain.models.RelationEdge>,
    nodes: Map<String, com.dadadadev.prototype_me.domain.models.EntityNode>,
    scale: Float,
    panOffset: Offset,
    density: Float,
